...
ImportedAsIsData <- read.csv(file.choose("Data/ImportedAsIsDataChulwalar.csv"), header = F, sep=";", fill = T) #chose ImportedAsIsDataChulwalar.csv

ImportedPlanData <- read.csv(file.choose("Data/ImportedPlanDataChulwalar.csv"), header = F, sep=";", fill = T) #chose ImportedPlanDataChulwalar.csv
...
ImportedIndicators <- read.csv(file.choose("Data/ImportedIndicatorsChulwalar.csv"), header = F, sep=";", fill = T) # chose ImportedIndicatorsChulwalar.csv
